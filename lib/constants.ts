export const services = [
  {
    ...
    description:
      "I create responsive, user-friendly websites using modern technologies like HTML, CSS, JavaScript, and frameworks like React and Next.js.",
    icon: "🌐",
  ...
  },
  {
    ...
    description:
      "I design and build robust backend systems using Node.js, Express, and MongoDB, ensuring efficient data handling and API management.",
    icon: "💻",
  ...
  },
  {
    ...
    description:
      "I craft intuitive interfaces with a focus on user experience, ensuring that websites and apps are both visually appealing and easy to navigate.",
    icon: "🎨",
  ...
  },
  {
    ...
    description:
      "Create efficient and scalable database designs to ensure data integrity, security, and optimal performance.",
    icon: "🗄️",
  ...
  },
  {
    ...
    description:
      "I integrate cloud services like AWS and Firebase to create scalable, secure, and highly available applications.",
    icon: "☁️",
  ...
  },
  {
    ...
    description:
      "Provide various IT-enabled services, including business process outsourcing, data management, and technical support.",
    icon: "💻",
...
//     shortDescription: "A comprehensive platform for educators to manage courses and students.",
//     description:
...
//     detailedDescription:
//       "Ignite LMS is designed to be an all-in-one solution for educators and learners. It streamlines the process of creating, managing, and delivering courses through an intuitive interface. The platform also offers tools for student progress tracking, quizzes, and assignment submissions. With role-based access, educators and students experience a tailored experience based on their needs.",
//     techStacks: [
...
//     detailedDescription:
//       "Career Hub is a job portal built for speed and user-friendliness. It offers advanced filtering options for job seekers to find opportunities based on location, company, and job type. For recruiters, the platform offers tools to post job listings and manage applicants efficiently, enabling smoother recruitment processes.",
//     description:
...
//     detailedDescription:
//       "Carewell is an appointment booking platform specially designed for healthcare. Patients can book appointments seamlessly, and the admin manages and monitors all appointments to ensure everything runs smoothly. The app focuses on enhancing patient care by reducing administrative hassles.",
//     description:
...
//     detailedDescription:
//       "Chat App is a simple and real-time messaging platform built for fast and smooth communication. It supports real-time messaging with read receipts, typing indicators, and group chat features. The app is optimized for performance, allowing users to stay connected across devices",
//     description:
...
//     detailedDescription:
//       "Mega Drive is a file storage and management platform designed to be secure and scalable. It offers features like multi-format file uploads, file organization through folders and tags, and remote access. Users can share files and folders securely, making it perfect for both personal and team use.",
//     description:
...
//     detailedDescription:
//       "DocStream is a Google Drive-inspired file management solution. It allows users to store, organize, and collaborate on documents in real-time. Features include file sharing, version control, and secure cloud storage, ensuring users can access their files anytime, anywhere.",
//     description:
...
//     detailedDescription:
//       "Phantom Feedback allows users to receive anonymous feedback, fostering open communication. It's perfect for teams and individuals seeking honest insights without the pressure of identity. Use it to gain feedback on personal, work, or team-based projects.",
//     description:
...
//     detailedDescription:
//       "Gymate UI is a sleek and simple user interface designed to showcase gym information and services. Users can browse gym locations, check amenities, and view class schedules. The UI is optimized for easy navigation, providing a clear and aesthetic view of the gym’s offerings.",
//     description:
...
//     detailedDescription:
//       "This project is an immersive clone of the iPhone 15 product website. It features smooth animations, a 3D model of the iPhone, and stunning transitions that replicate the feel of the original site. The focus is on creating an engaging user experience with cutting-edge animations.",
//     description:
