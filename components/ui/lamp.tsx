...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[30vh] md:h-[34vh] flex-col items-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="absolute top-24 ">
        <div className="border relative flex w-full flex-1 scale-y-120 items-center justify-center z-0 mt-4">
          <motion.div
      ...
      <div className="absolute top-4  z-50 flex flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
