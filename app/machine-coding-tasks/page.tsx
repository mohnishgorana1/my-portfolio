          ...
          <div className="space-y-4 mx-auto border px-1 sm:px-4 py-4 md:py-2 rounded-lg shadow-sm shadow-neutral-600 border-neutral-800">
            ...
            {c.name === "NESTED CHECKBOX" && (
              <article className="space-y-2 text-base text-gray-400">
                ...
                <span className="text-neutral-500">
                  ⚡ Note: I have not used any shadcn or other UI library. The
                  entire "Nested Checkbox" component is built using plain React
                  + Tailwind CSS.
                </span>
              </article>
            )}
            {c.name === "CHIPS INPUT" && (
              <article className="space-y-2 text-base text-gray-400">
                <p className="text-gray-200">
                  A dynamic <strong>Chips Input</strong> component that allows
                  users to enter multiple values as chips by pressing{" "}
                  <kbd>Enter</kbd>. Each chip can be deleted individually.
                </p>
